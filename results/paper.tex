...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{architecture_diagram.png}}
...
\section{Datasets}
To prove zero-shot extrapolation, two massive, open-source networking datasets were utilized for cross-validation.
